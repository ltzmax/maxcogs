...
|:---:|---|:---:|:---:|:---:|
| AutoPublisyher | Automatically push news channel messages. | 2.1.4 | ltzmax | ✅ |
| Chest | First to click the button gets random credits to their `[p]bank balance`. | 1.0.3 | ltzmax | ✅ |
| GitHub | GitHub RSS Commit Feeds | 1.0.0 | Obi-Wan3, ltzmax | ✅ |
| lockdown | Let moderators lockdown a channel to prevent messages from being sent. | 1.0.8 | ltzmax | ✅ |
