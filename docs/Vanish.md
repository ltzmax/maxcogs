...
This will allow you to self-timeout yourself, similar to Twitch's timeout command from streamelemets and fossabot and probably hundered of other twitch bots.<br/><br/>Note to admins: It is not recommended to set the timeout duration to very high values as users will not be able to interact in any way in the server during the timeout period.

## [p]vanish (Hybrid Command)
...
Moderators, administrators and the guild owner cannot timeout themselves using the vanish command.<br/>
